defmodule Intercom do
  ...
  def escape_value(value) when is_binary(value),
    do: value |> Escaping.html_escape() |> Builder.literal()
  ...
  def snippet(props, opts) when is_map(props) do
    ...
    nonce_attr =
      case opts[:csp_nonce] do
        nil -> ""
        nonce -> " nonce=\"#{nonce}\""
      end

    base =
      "<script#{nonce_attr}>(function(){var w=window;var ic=w.Intercom;if(typeof ic===\"function\"){ic('reattach_activator');ic('update',intercomSettings);}else{var d=document;var i=function(){i.c(arguments)};i.q=[];i.c=function(args){i.q.push(args)};w.Intercom=i;function l(){var s=d.createElement('script');s.type='text/javascript';s.async=true;s.src='https://widget.intercom.io/widget/#{app_id}';var x=d.getElementsByTagName('script')[0];x.parentNode.insertBefore(s,x);}if(w.attachEvent){w.attachEvent('onload',l);}else{w.addEventListener('load',l,false);}};})();"
